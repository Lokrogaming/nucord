...
const USERS: Record<string, User> = {
  '1': { id: '1', username: 'Andri', discriminator: '0001', status: 'online', bio: 'Expert Frontend Engineer & UI/UX Enthusiast.', bannerColor: '#00E5FF' },
  '2': { id: '2', username: 'Nelly', discriminator: '1337', status: 'dnd', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Nelly', bio: 'Designing the future, one pixel at a time.', bannerColor: '#FF0055' },
  '3': { id: '3', username: 'CyborgBot', discriminator: '9999', status: 'online', isBot: true, avatar: 'https://api.dicebear.com/7.x/bottts/svg?seed=Cyborg', bio: 'Beep boop. I am here to help.', bannerColor: '#7000FF' },
  '4': { id: '4', username: 'Ghosty', discriminator: '6666', status: 'idle', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Ghosty', bio: 'I haunt the code.', bannerColor: '#00FF94' },
};
